...
if __name__ == "__main__":
    ...
    # Construct the paths to the checkpoint files
    pretrained_path = os.path.join(current_dir, "checkpoints", config["arch"], "zeroshot.pt")
    finetuned_path = os.path.join(current_dir, "checkpoints", config["arch"], "Cars", "finetuned.pt")
    cars_head_path = os.path.join(current_dir, "checkpoints", config["arch"], "head_Cars.pt")
